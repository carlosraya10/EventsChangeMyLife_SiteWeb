    ...
    if ($_FILES["userfile"]["type"]=="image/jpeg" || $_FILES["userfile"]["type"]=="image/pjpeg" || $_FILES["userfile"]["type"]=="image/gif" || $_FILES["userfile"]["type"]=="image/bmp" || $_FILES["userfile"]["type"]=="image/png")
    {
        ...
        echo "<div class='error'>Error: Le format du fichier doit être JPG, GIF, BMP ou PNG.</div>";
			...
			if($_id_ad>0)
			{
				...
				echo "<div class='button'><span><a href='spaceClient_ad_onlyWatch.php?currentIdAd=$_id_ad' class='details'>Regarder</a></span></div>";//Détails
				echo "<div class='button'><span><img src='images/cart.jpg' alt='' /><a href='spaceClient_ad.php?currentIdAd=$_id_ad' class='cart-button'>Modifier</a></span></div>";//Button Séleccioner
				echo "</div>";
				$nohay++;
			}
endforeach;
